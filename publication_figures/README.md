...
### Appendix Figure C1: Forest plot of the squared English-share (curvature) coefficient across all H1 specifications

The accepted image is shown below. The reproduced version is available
...
### Appendix Figure C2: Forest plot of the interaction coefficient across all specifications, faceted by moderator
...
## Accepted and generated versions

The accepted C1 and C2 images include publication annotations that are not part
of the reproduced versions. Both are retained: the accepted images show what
